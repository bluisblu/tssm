...
void iCameraMotionBlurActivate(U32 activate) { sMotionBlurEnabled = activate; }

// The instructions regarding the setting of sMotionBlurEnabled and
// sMBD.motionBlurAlpha are in the wrong order.
...
void iScrFxPostCameraEnd(RwCamera *pCamera) { GCMB_SiphonFrameBuffer(pCamera); }
