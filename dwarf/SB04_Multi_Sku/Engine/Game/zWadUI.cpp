...
typedef void* (*type_0)(xTextureHandle*);
typedef void (*type_1)(jot&, xtextbox&, float32, float32);
typedef void (*type_2)(void*, uint32);
typedef void (*type_8)(jot&, xtextbox&, xtextbox&);
typedef void (*type_9)(void*, uint32, void*, int8*);
typedef void (*type_11)(xEnt*, xScene*, float32);
typedef void (*type_13)(jot&, xtextbox&, xtextbox&, split_tag&);
typedef void (*type_15)(zDestructible*, void*);
...
typedef uint32 (*type_33)(float32);
typedef uint32 (*type_37)(xEnt*, xEnt*, xScene*, float32, xCollis*);
typedef void* (*type_39)(uint32, void*);
typedef void (*type_40)(xEnt*, xVec3*, xMat4x3*);
typedef RpAtomic* (*type_43)(RpAtomic*);
typedef void (*type_45)(zFrag*, zFragAsset*);
typedef RpWorldSector* (*type_49)(RpWorldSector*);
typedef uint32 (*type_50)(uint32, xAnimActiveEffect*, xAnimSingle*, void*);
typedef void (*type_55)(zShrapnelAsset*, xModelInstance*, xVec3*, void (*)(zFrag*, zFragAsset*));
typedef void (*type_57)(xBase*, xBase*, uint32, float32*, xBase*, uint32);
typedef uint32 (*type_63)(xAnimTransition*, xAnimSingle*, void*);
typedef void* (*type_64)(uint32, void*);
typedef xBase* (*type_68)(uint32);
typedef uint32 (*type_72)(void*, void*);
typedef int8* (*type_75)(xBase*);
typedef int8* (*type_78)(uint32);
typedef void (*type_80)(void*);
typedef void (*type_82)(xAnimState*, xAnimSingle*, void*);
typedef void* (*type_89)(void*, uint32, void*, uint32, uint32*);
typedef void (*type_95)(tweak_info&);
typedef void (*type_96)(xAnimPlay*, xQuat*, xVec3*, int32);
typedef RwCamera* (*type_98)(RwCamera*);
typedef RwCamera* (*type_100)(RwCamera*);
typedef void* (*type_101)(void*, uint32, void*, void*, uint32, uint32*);
typedef void (*type_102)(xAnimPlay*, xAnimState*, void*);
typedef void (*type_109)(zUI*, uint32, uint32, float32*, xBase*, uint32, void*);
typedef uint32 (*type_110)(RxPipelineNode*, uint32, uint32, void*);
typedef int32 (*type_116)(void*, uint32, void*, int32);
typedef void (*type_117)(RwResEntry*);
typedef int32 (*type_118)(RxPipelineNode*, RxPipeline*);
typedef RwObjectHasFrame* (*type_119)(RwObjectHasFrame*);
typedef void (*type_120)(tweak_info&, void*);
typedef void (*type_122)(RxPipelineNode*);
typedef int32 (*type_125)(RxPipelineNode*);
typedef void (*type_128)(RxNodeDefinition*);
typedef int32 (*type_133)(RxNodeDefinition*);
typedef void* (*type_134)(void*, uint32, void*, int32*, int32*);
typedef void (*type_138)(xBase*, xBase*, uint32, float32*, xBase*, uint32);
typedef int32 (*type_141)(RxPipelineNode*, RxPipelineNodeParam*);
typedef void (*type_143)(void*, uint32, void*);
typedef void (*type_145)(xMemPool*, void*);
typedef void (*type_146)(zUI*, uint32, uint32, float32*, xBase*, uint32, void*);
typedef RpClump* (*type_149)(RpClump*, void*);
typedef void (*type_161)(xEnt*);
typedef void* (*type_162)(xTextureHandle*, int16);

typedef float32 type_3[4];
typedef RwV3d type_4[8];
typedef uint8 type_5[2];
typedef uint8 type_6[22];
typedef xVec3 type_7[60];
typedef RwFrustumPlane type_10[6];
typedef uint8 type_12[22];
typedef float32 type_14[2];
typedef uint32 type_16[4];
typedef zUI* type_17[16];
typedef uint16 type_18[3];
typedef float32 type_20[2];
typedef _tagxPad* type_21[4];
typedef uint32 type_23[20];
typedef uint32 type_24[8];
typedef uint32 type_26[20];
typedef uint8 type_27[3];
typedef jot type_28[512];
typedef xCollis type_29[18];
typedef jot_line type_31[128];
typedef int8 type_32[16];
typedef void* type_34[32];
typedef uint8 type_35[16];
typedef uint32 type_36[20];
typedef uint32 type_38[4];
typedef uint8 type_41[1024];
typedef uint8 type_42[2];
typedef uint32 type_44[4096];
typedef int8 type_46[32];
typedef uint8 type_47[3];
typedef uint16 type_48[64];
...
typedef int32 type_70[141];
typedef xModelTag type_71[2];
typedef zUI* type_73[1024];
typedef float32 type_74[16];
typedef int8 type_76[16];
typedef xBase* type_77[141];
typedef analog_data type_79[2];
typedef xEntBoulder* type_81[2];
typedef float32 type_83[3];
typedef float32 type_84[6];
typedef uint8 type_85[10];
typedef void* type_86[3];
typedef xVec3 type_87[4];
typedef RwTexCoords* type_88[8];
typedef xJSPMiniLightTie type_90[16];
typedef float32 type_91[3];
typedef uint8 type_92[10];
typedef uint16 type_93[4];
typedef uint32 type_94[2];
typedef float32 type_97[3];
typedef float32 type_99[3];
typedef float32 type_103[2];
typedef int8 type_104[4];
typedef xVec3 type_105[5];
typedef float32 type_106[4];
typedef uint8 type_107[5];
typedef xModelTag type_108[4];
typedef uint8 type_111[3];
typedef xEnt* type_112[161];
typedef xTextureHandle type_113[9];
typedef RwSky2DVertex type_114[4];
typedef _tagTRCPadInfo type_115[4];
typedef xCam* type_121[32];
typedef int8 type_123[32];
typedef int8 type_124[32];
typedef uint8 type_126[3];
typedef xParInterp type_127[1];
typedef RwSky2DVertex type_129[4];
typedef float32 type_130[13];
typedef xVec4 type_131[12];
typedef float32 type_132[13];
typedef xCamBlend* type_135[4];
typedef xModelInstance* type_136[11];
typedef uint32 type_137[59];
typedef float32 type_139[13];
typedef uint8 type_140[4];
typedef float32 type_142[13];
typedef float32 type_144[13];
typedef xVec4 type_147[12];
typedef float32 type_148[13];
typedef float32 type_150[13];
typedef RwTexCoords* type_151[8];
typedef xParInterp type_152[4];
typedef int8 type_153[32];
typedef xParInterp type_154[4];
typedef<unknown fundamental type(0xa510)> type_155[4];
typedef uint8* type_156[40];
typedef uint8 type_157[3];
typedef uint8 type_158[3];
typedef uint8 type_159[3];
typedef uint32 type_160[2];
typedef int8 type_163[127];
typedef uint8 type_164[3];
typedef uint8 type_165[3];
typedef xVec3 type_166[3];
...
struct zUI : xBase
{
    ...
    void DoInitMotion();
    void ApplyMotion();
    float32 CalcAcceleratedDistance(float32 totalDistance, float32 startTime, float32 endTime,
                                    float32 accelTime, float32 decelTime);
...
struct zUIImage : zUI
{
    ...
    void DoInitMotion();
    void DoRender();
    void DoHandleEvent(xBase* from, uint32 toEvent, float32* toParam, xBase* toParamWidget,
...
struct zUIBox : zUI
{
    ...
    void RenderPart(int32 p, float32 x1, float32 y1, float32 x2, float32 y2, float32 uScale,
                    float32 vScale, float32 rotation, float32 xPivot, float32 yPivot);
    void DoRender();
    void DoApplyMotionFrame(zUIMotionFrame* frame);
    void DoHandleEvent(xBase* from, uint32 toEvent, float32* toParam, xBase* toParamWidget,
                       uint32 toParamWidgetID);
...
struct tweak_info
{
    ...
    union
    {
        _class_3 int_context;
        _class_4 uint_context;
        _class_7 float_context;
        _class_9 bool_context;
        _class_12 select_context;
        _class_0 flag_context;
        _class_2 all_context;
    };
};
...
float32 thresh;
float32 thresh;
_anon4 __vt__14zLoadingScreen;
uint32 ourGlobals[4096];
uint8 HDR_brightening;
_anon1 __vt__30zUICustomConditionallyDisabled;
_anon3 __vt__9zUICustom;
_anon5 __vt__23zUICustomImageSlideshow;
uint32 gActiveHeap;
...
_anon6 __vt__13zUIController;
_anon2 __vt__3zUI;
_anon10 __vt__7zUIText;
void* (*__dt)(xTextureHandle*, int16);
void* (*__ct)(xTextureHandle*);
_anon0 __vt__6zUIBox;
_anon8 __vt__8zUIImage;
void* (*CustomStaticAllocator)(uint32, void*);
_anon9 __vt__13zUIUserString;
_anon7 __vt__8zUIModel;
xScene* g_xSceneCur;
